...
#define SCREEN_WIDTH	777//777/1111
#define SCREEN_HEIGHT	585
#define STAGE_WIDTH	SCREEN_WIDTH*5//777/1111
#define STAGE_HEIGHT	SCREEN_HEIGHT*5
#define ENEMY_X 544
#define ENEMY_Y 144
...
//	                                 &window, &renderer);
	...
	playControl(&quit, &new_game, &x_pos, &y_pos, &t1, &t2, &worldTime, &distance, &etiSpeed, screen, renderer, etis[RIGHT], etis[LEFT], yellow_dot, pink_dot, charset, scrtex,
		rgb[0], rgb[4], rgb[3], &fpsTimer, &frames, &fps, text, &delta, event, etis);
